The Spring.NET Social LinkedIn project, Release 1.0 M2 (July 31, 2013)
----------------------------------------------------------------------
...
Bug, issue and project tracking can be found at https://jira.springsource.org/browse/SPRNETSOCIALLI

A source repository browser is located at https://fisheye.springsource.org/changelog/spring-net-social-linkedin

A continuous intergration and build server is located at https://build.springframework.org/browse/SPRNETSOCIALLI

To get the sources, check them out at the git repository at https://github.com/SpringSource/spring-net-social-linkedin using a git client to deal with line endings.
